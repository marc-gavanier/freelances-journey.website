...
import { AccessAndTransport, Location } from '@/app/_schemas';
    ...
    <>
      <div className='container py-6'>
        ...
        <div className='row g-3'>
          {transports.trainStations?.map(LocationItem)}
          {transports.subwayStations?.map(LocationItem)}
          {transports.tramStops?.map(LocationItem)}
          {transports.busStops?.map(LocationItem)}
          {transports.parkingLots?.map(LocationItem)}
        </div>
